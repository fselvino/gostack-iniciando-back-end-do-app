...
let CreateAppointmentService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
...
}, _dec5 = Reflect.metadata("design:type", Function), _dec6 = Reflect.metadata("design:paramtypes", [typeof _IAppointementsRepository.default === "undefined" ? Object : _IAppointementsRepository.default, typeof _INotificationsRepository.default === "undefined" ? Object : _INotificationsRepository.default, typeof _ICacheProvider.default === "undefined" ? Object : _ICacheProvider.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = _dec6(_class = class CreateAppointmentService {
  ...
  async execute({
    ...
    const appointmentDate = (0, _dateFns.startOfHour)(date); // console.log(appointmentDate);

    if ((0, _dateFns.isBefore)(appointmentDate, Date.now())) {
      throw new _AppError.default("You can't create an appointemt on a past date");
    } // console.log(Date.now());


    if (user_id === provider_id) {
      throw new _AppError.default("You can't create an appointemt with yourself");
    }
    ...
    const findAppointmentInSameDate = await this.appointmentsRepository.findByDate(appointmentDate, provider_id); // Se existir a data retorna erro de agendamento.

    if (findAppointmentInSameDate) {
      throw new _AppError.default('Já existe um agendamento para esse horário');
