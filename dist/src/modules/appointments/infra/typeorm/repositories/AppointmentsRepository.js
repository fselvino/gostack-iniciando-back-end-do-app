                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, this.ormRepository.find({
                                where: {
                                    ...
                                    date: typeorm_1.Raw(function (dateFildName) {
                                        return "to_char(" + dateFildName + ", 'MM-YYYY') = '" + parsedMonth + "-" + year + "'";
                                    }),
                                },
                            })];
                    case 1:
                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, this.ormRepository.find({
                                where: {
                                    provider_id: provider_id,
                                    date: typeorm_1.Raw(function (dateFildName) {
                                        return "to_char(" + dateFildName + ", 'DD-MM-YYYY') = '" + parsedDay + "-" + parsedMonth + "-" + year + "'";
                                    }),
                                },
                                relations: ['user']
                            })];
