                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (date_fns_1.isBefore(appointmentDate, Date.now())) {
                            throw new AppError_1.default("You can't create an appointemt on a past date");
                        }
                        // console.log(Date.now());
                        if (user_id === provider_id) {
                            throw new AppError_1.default("You can't create an appointemt with yourself");
                        }
                    ...
                    case 1:
                        ...
                        if (findAppointmentInSameDate) {
                            throw new AppError_1.default('Já existe um agendamento para esse horário');
                        }
