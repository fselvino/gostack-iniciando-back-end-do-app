...
var FakesNotificationsRepository_1 = __importDefault(require("@modules/notifications/repositories/fakes/FakesNotificationsRepository"));
var FakeCacheProvider_1 = __importDefault(require("@shared/container/provider/CacheProvider/fakes/FakeCacheProvider"));
var FakeAppointmentsRepository_1 = __importDefault(require("../repositories/fakes/FakeAppointmentsRepository"));
var CreateAppointmetService_1 = __importDefault(require("./CreateAppointmetService"));
...
describe('CreateAppointment', function () {
    beforeEach(function () {
        ...
        fakeNotificationsRepository = new FakesNotificationsRepository_1.default();
        createAppointment = new CreateAppointmetService_1.default(fakeAppointmentsRepository, fakeNotificationsRepository, fakeCacheProvider);
    });
    ...
    it('should not be able to create two appointments on the same time', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    appointmentDate = new Date(2020, 7, 5, 9);
