...
var ListProviderDayAvailabilityService = /** @class */ (function () {
    ...
    ListProviderDayAvailabilityService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointments, hourStart, eachHourArray, currentDate, availablility;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, eachHourArray.map(function (hour) {
                    ...
                    case 2:
                        availablility = _b.sent();
                        // console.log(availablility);
                        return [2 /*return*/, availablility];
                }
            });
        });
    };
