...
var ResetePasswordServide = /** @class */ (function () {
    function ResetePasswordServide(usersRepository, UserTokensRepository, hashProvider) {
        this.usersRepository = usersRepository;
        this.UserTokensRepository = UserTokensRepository;
        this.hashProvider = hashProvider;
    }
    ResetePasswordServide.prototype.execute = function (_a) {
    ...
    ResetePasswordServide = __decorate([
        tsyringe_1.injectable(),
        __param(0, tsyringe_1.inject('UsersRepository')),
        __param(1, tsyringe_1.inject('UserTokensRepository')),
        __param(2, tsyringe_1.inject('HashProvider')),
        __metadata("design:paramtypes", [Object, Object, Object])
    ], ResetePasswordServide);
    return ResetePasswordServide;
}());
exports.default = ResetePasswordServide;
