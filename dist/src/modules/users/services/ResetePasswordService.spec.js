...
var ResetePasswordService_1 = __importDefault(require("./ResetePasswordService"));
var fakeUsersRepository;
var fakeUserTokensRepository;
var fakeHashProvider;
var resetePassword;
describe('ResetePasswordServide', function () {
    beforeEach(function () {
        ...
        resetePassword = new ResetePasswordService_1.default(fakeUsersRepository, fakeUserTokensRepository, fakeHashProvider);
    });
    it('should be able to recover the password using the email', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, userToken, generateHash, updatedUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, resetePassword.execute({
                            password: '123123',
    ...
    it('shoud not be able to reset the password with non-existing token', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(resetePassword.execute({
    ...
    it('shoud not be able to reset the password with non-existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    token = (_a.sent()).token;
                    return [4 /*yield*/, expect(resetePassword.execute({
                            token: token,
                            password: '123456',
                        })).rejects.toBeInstanceOf(AppError_1.default)];
                case 2:
