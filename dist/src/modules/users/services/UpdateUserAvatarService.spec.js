...
var FakeStorageProvider_1 = __importDefault(require("@shared/container/provider/storageProvider/fakes/FakeStorageProvider"));
...
describe('UpdateUserAvatar', function () {
    ...
    it('should not be able to update avatar non existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
